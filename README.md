...
Important: if you work on something related to undetection, like humanizing puppeteer actions, we may consider collaboration as I'm working currently on it too. My [TG](https://t.me/hidemium).

# Anti-detect browsers
* [Hidemium](https://hidemium.io/) - 1000 Free Profiles trials.
* [NSTBrowser](https://app.nstbrowser.io/) - 10 profiles opened / day free, $299 for 3000 open profiles per day, quite new on the market.
* [Undetectable](https://undetectable.io/) - 5 cloud profiles free, $49 for unlimited local with 25 "configs", 1 additional config $1 (API + driver automation)
* [Multilogin](https://multilogin.com/) - starts from €74 for 100 profiles  
* [Incogniton](https://incogniton.com/) - 10 free, $29.99/Month for 50
* [Octo Browser](https://octobrowser.net) - starts from €21 for 10  
* [Gologin](https://go.gologin.com/) - $24 for 100 profiles, no unlimited plan, free proxies  
* [AdsPower](https://share.adspower.net) - 2 profiles free, $5.4 for 10 profiles, no unlimited plan  
* [Morelogin](https://www.morelogin.com) - 2 free, $9 for 10 profiles and 2 users  
* [Dolphin-anty](https://dolphin-anty.com/a/) - 10 free, $89 for 100  
...
* [DataImpulse](https://dataimpulse.com/) - from $1/GB (has $5/5Gb welcome package, but normally from $50). IMAP/SMTP blocked.
* [WebShare](https://www.webshare.io/) - $6/Gb (from 4.5), cheap status: from $6/month per 20. IMAP/SMTP works.
* [GeoNode](https://geonode.com/) - $4/Gb (from $1.7)
* [LunaProxy](https://www.lunaproxy.com) - $3/Gb (from $0.8), has static too ($3/week, $5/month), IMAP/SMTP blocked.
* [Piaproxy](https://account.piaproxy.com/)
* [Soax](https://soax.com) - starts at $6.6/GB and less
* [IPRoyal](https://iproyal.com/) - starts at around 5.25/GB for 10GB, less too expensive (IMAP only if spending 5k)
* [922proxy](https://www.922proxy.com/) - $3/GB (up to 60 min), $0.22/IP, $5/30 days
* [BrightData](https://get.brightdata.com/) - around $8/GB
* [9proxy.com](https://9proxy.com/) - $0.07-0.2/IP
